                        ...
                        do
                        {
                            do
                            {
                                do
                                {
                                    ...
                                    if (iter.IsAtFinalOf(PageIteratorLevel.Word, PageIteratorLevel.Symbol)) output.Append("</word>");
                                } while (iter.Next(PageIteratorLevel.Word, PageIteratorLevel.Symbol));

                                if (iter.IsAtFinalOf(PageIteratorLevel.TextLine, PageIteratorLevel.Word)) output.AppendLine("</line>");
                            } while (iter.Next(PageIteratorLevel.TextLine, PageIteratorLevel.Word));

                            if (iter.IsAtFinalOf(PageIteratorLevel.Para, PageIteratorLevel.TextLine)) output.AppendLine("</para>");
